...
export default function Setup() {
  ...
  const [step, setStep] = useState<
    "splash" | "auth" | "socials" | "works" | "avatar" | "ready"
  >("splash");
  ...
  const handleAuthSubmit = async () => {
    ...
    try {
      ...
      const existing =
        (await getNailTechBySlug(input)) || (await getNailTechByEmail(input));
      ...
      if (existing) {
        ...
        const slug = input.includes("09")
          ? `tech_${crypto.randomUUID().slice(0, 6)}`
          : input.replace("@", "");
        setTechInfo((prev) => ({
          ...prev,
  ...
  const handleDesignImageUpload = useCallback(
  ...
  }, [showAddModal, step, handleDesignImageUpload, handleAvatarUpload]);
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      const savedTech = await saveNailTech({
        ...
        email: techInfo.email || `${finalSlug}@example.com`,
        name: techInfo.name,
        ...
        <div className="flex-1 flex flex-col justify-between p-8 bg-white text-center">
          <div className="pt-8">
            ...
            <p className="text-xs text-neutral-500 mt-2 font-medium leading-relaxed px-2">
              ویترین آنلاین کارهای خود را بسازید، لینک اختصاصی بیو اینستاگرام
              دریافت کنید و نوبت‌دهی خود را ساده کنید.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400 mt-1 font-semibold">
                  در صورت وجود حساب وارد می‌شوید، در غیر این صورت حساب جدید
                  ساخته می‌شود.
                </p>
              </div>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5 relative">
                ...
                {showCityDropdown && (
                  <div
                    ref={cityDropdownRef}
                    className="absolute z-30 left-0 right-0 mt-2 bg-white rounded-[16px] border border-neutral-200 shadow-xl overflow-hidden flex flex-col max-h-[200px]"
                  >
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  ...
                  {techInfo.instagram &&
                    isValidInstagramHandle(techInfo.instagram) && (
                      <a
              ...
              {/* Username / Custom URL Slug */}
              <div className="space-y-1.5">
                <label className="text-neutral-700 text-xs font-bold flex items-center justify-between">
                ...
                <p className="text-[11px] font-medium text-neutral-500 text-right">
                  آدرس اختصاصی ویترین:{" "}
                  <span className="text-[#EC4899] font-bold dir-ltr inline-block">
                    vitrin.ir/vitrin/{techInfo.slug || "username"}
                  </span>
                </p>
              </div>
              ...
              {designs.length > 0 && (
                <div className="space-y-2.5">
                  {designs.map((item) => (
                    <div
                      key={item.id}
                      className="bg-neutral-50 border border-neutral-200 rounded-[16px] p-3 flex items-center justify-between gap-3"
                    >
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center justify-center py-4 space-y-3">
                <div className="relative">
                  {techInfo.avatar_url ? (
                    ...
                    <label
                      ...
                      className="w-32 h-32 border-2 border-dashed border-[#EC4899] bg-pink-50/20 hover:bg-pink-50/50 rounded-full flex flex-col items-center justify-center cursor-pointer transition-all space-y-0.5"
                    >
                ...
                <button
                  ...
                  className="text-xs font-bold text-[#EC4899] bg-pink-50 hover:bg-pink-100 px-3.5 py-1.5 rounded-full border border-pink-200/80 flex items-center gap-1.5 cursor-pointer transition-all"
                >
                  <Clipboard className="w-3.5 h-3.5 text-[#EC4899]" />
          ...
          <div className="flex-1 flex flex-col justify-between p-8 bg-white text-center">
            <div className="pt-6">
              ...
              <p className="text-xs text-neutral-500 font-semibold mt-2 leading-relaxed">
                ویترین آنلاین شما با موفقیت ساخته شد. می‌توانید لینک اختصاصی زیر
                را کپی کرده و در بیو اینستاگرام خود قرار دهید.
              </p>
            </div>
            ...
            <div className="bg-white rounded-t-[24px] p-6 max-h-[90%] overflow-y-auto no-scrollbar space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-[11px] font-bold text-[#EC4899] hover:bg-pink-50 px-2.5 py-1 rounded-lg border border-pink-200/60 flex items-center gap-1 cursor-pointer transition-all"
                  >
                    <Clipboard className="w-3.5 h-3.5 text-[#EC4899]" />
                ...
                {newDesign.image_url ? (
                  <div className="relative aspect-square max-w-[140px] mx-auto rounded-xl overflow-hidden border border-neutral-200">
                    ...
                    <button
                      ...
                      className="absolute top-1.5 left-1.5 bg-white text-neutral-800 rounded-full p-1 shadow cursor-pointer"
                    >
                  ...
                  <label
                    ...
                    className="w-full py-6 border-2 border-dashed border-neutral-300 hover:border-[#EC4899] bg-neutral-50 rounded-xl flex flex-col items-center justify-center cursor-pointer transition-all space-y-1"
                  >
                    <Plus className="w-6 h-6 text-neutral-400" />
                    <span className="text-[11px] font-bold text-neutral-700">
                      انتخاب یا آپلود عکس
                    </span>
                    <span className="text-[10px] font-bold text-[#EC4899] bg-pink-50 px-2 py-0.5 rounded-full border border-pink-100">
                ...
                {uploadingDesign && (
                  <div className="text-[10px] text-[#EC4899] font-bold text-center animate-pulse">
                    در حال آپلود...
                  </div>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewDesign((prev) => ({ ...prev, title: e.target.value }))
                  }
                />
              </div>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    ...
                    {!showAddColorInput && (
                      <button
                        ...
                        className="text-[11px] font-bold text-[#EC4899] hover:underline flex items-center gap-0.5 cursor-pointer"
                      >
                  ...
                  {showAddColorInput && (
                    <div className="flex items-center gap-1.5 py-1">
                      <input
                        ...
                        className="flex-1 px-3 py-2 bg-neutral-50 border border-pink-200 rounded-xl text-xs font-bold outline-none focus:border-[#EC4899]"
                        value={newColorInput}
                      ...
                      <button
                        ...
                        className="px-3 py-2 bg-[#EC4899] text-white rounded-xl text-xs font-bold cursor-pointer hover:bg-[#DB2777]"
                      >
                        ثبت
                      </button>
                      <button
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {availableColorOptions.map((c) => {
                      const selected = newDesign.selectedColors.includes(
                        c.name,
                      );
                      return (
                        <button
