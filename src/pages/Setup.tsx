...
export default function Setup() {
  ...
  const handleAuthSubmit = async () => {
    ...
    try {
      ...
      const existing = (await getNailTechBySlug(input)) || (await getNailTechByEmail(input));
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] font-medium text-neutral-500 text-right">
                  آدرس اختصاصی ویترین: <span className="text-[#EC4899] font-bold dir-ltr inline-block">vitrin.ir/vitrin/{techInfo.slug || 'username'}</span>
                </p>
              </div>
                ...
                <div className="relative">
                  {techInfo.avatar_url ? (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-bold text-[#EC4899]">انتخاب یا آپلود عکس</span>
                      <input 
                        type="file" 
                        accept="image/*" 
                        className="hidden" 
              ...
              <div className="space-y-1.5">
                ...
                {newDesign.image_url ? (
                  ...
                  >
                    ...
                    <span className="text-[11px] font-bold text-neutral-700">انتخاب یا آپلود عکس</span>
                ...
                {uploadingDesign && (
                  <div className="text-[10px] text-[#EC4899] font-bold text-center animate-pulse">در حال آپلود...</div>
                )}
              </div>
